...
var _b = __webpack_require__(308);
...
// console.log("app:", new a("komo", "male"));
// console.log("dsdfa")
// a()
var ad = new _a.ab("komolei", "male");

// console.log("class", ad.name,ad.getName());
// import { komo } from "./src/js/a.js"
// console.log("app:", komo());
console.log("class extends", ad.name, ad.getHeight(), "name:", ad.Name());
...
// let komo = `<p>hello weapack!</p>`
// document.body.innerHTML = komo;
// setInterval(()=>{
//     console.log("xiaojiahuo")
// },1000);
...
var a = 3;
var komo = function komo() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { x: 5, y: 4 },
        _ref$x = _ref.x,
...
var ab = function (_clc) {
    _inherits(ab, _clc);

    function ab(name, sex, height) {
        _classCallCheck(this, ab);

        var _this = _possibleConstructorReturn(this, (ab.__proto__ || Object.getPrototypeOf(ab)).call(this, name, sex));
    ...
    _createClass(ab, [{
        ...
        key: "Name",
        value: function Name() {
            _get(ab.prototype.__proto__ || Object.getPrototypeOf(ab.prototype), "getName", this).call(this);
        }
    }]);
...
module.exports = __webpack_require__(43)|| !__webpack_require__(14)(function(){
  var K = Math.random();
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(22)(proto, TO_PRIMITIVE, __webpack_require__(208));
...
$export($export.P + $export.F * (__webpack_require__(56) != Object || !__webpack_require__(31)(arrayJoin)), 'Array', {
...
if(__webpack_require__(17) && (!CORRECT_NEW || __webpack_require__(14)(function(){
...
var $export = __webpack_require__(11)
  , $values = __webpack_require__(122)(false);
...
// https://github.com/tc39/proposal-object-values-entries
var $export  = __webpack_require__(11)
  , $entries = __webpack_require__(122)(true);
...
__webpack_require__(17) && $export($export.P + __webpack_require__(69), 'Object', {
